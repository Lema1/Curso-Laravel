                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            <select class="form-control col-md-3" v-model="criterio">
                                <option value="tipo_comprobante">Tipo Comrpobante</option>
                                <option value="num_comprobante">Numero Comrpobante</option>
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody v-if="arrayDetalle.length">
                                <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                    ...
                                    <td>
                                        <input v-model="detalle.precio" type="number" value="" class="from-control">
                                    </td>
                                    <td>
                                        <input v-model="detalle.cantidad" type="number" value="" class="from-control">
                                    </td>
    ...
    export default {
        ...
        methods: {
            ...
            validarPersona(){
                ...
                if(this.rol=0){ this.errorMostrarMsjPersona.push('Debe selecionar un rol')};
            ...
            abrirModal(){
                this.arrayArticulo=[]
                this.modal = 1;
                this.tituloModal = 'Selecione uno o varios Articulos';
            }
        },
        mounted() {
