...
class VentaController extends Controller
{
    public function index(Request $request){
        ...
        if($buscar==''){
            ...
            ->select('ventas.id','ventas.tipo_comprobante','ventas.serie_comprobante','ventas.num_comprobante','ventas.fecha_hora',
            ...
            ->select('ventas.id','ventas.tipo_comprobante','ventas.serie_comprobante','ventas.num_comprobante','ventas.fecha_hora',
            'ventas.impuesto','ventas.total','ventas.estado','personas.nombre','users.usuario')
            ->where('ventas.'.$criterio,'like','%'. $buscar .'%')->orderBy('ventas.id','desc')->paginate(4);
        }
    ...
    public function obtenerCabecera(Request $request){
        ...
        'ventas.fecha_hora','ventas.impuesto','ventas.total','ventas.estado','personas.nombre','users.usuario')
        ->where('ventas.id','=',$id)
